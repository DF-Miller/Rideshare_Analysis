...
* Weather
  ...
  * Visibility also does not appear to affect ride prices, unless there is under 0.5 miles of visibility. When Visibility falls under 0.5 miles, there average cost of a ride increases by 50 cents. Aside from this, there is no obvious trend in price change as visibility decreases. When visibility is grouped in 1-mile increments (Visivilty is the distance in miles a person can clearly see horizontally), the percentage change in pricing appears random, showing both increases and decreases in price as visibility worsens. Prices when visibility is limited to 1 mile are nearly 2 cents cheaper than when visibility is 10 miles.
  -- Pictures 
* Time
